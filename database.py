...
# 보안을 위해 환경변수 사용을 권장하며, 비밀번호 부분은 실제 비밀번호로 채워야 한다.
...
# 한글 주석: DATABASE_URL이 None이면 서버 실행을 중단하고 에러 메시지를 보여준다.
...
# 한글 주석: pool_pre_ping은 연결 유효성을 검사하여 'Connection Lost' 에러를 방지
